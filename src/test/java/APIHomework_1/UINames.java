...
//3. Verify that name, surname, gender, region fields have value
    ...
    //This method give me random name surname gender and region
    @Test
...
//    }
//    //getProperty("user.dir") will provide project path:/Users/tugba/IdeaProjects/ApiShorts/src/test/java/APIHomework_1/names.json
//    File namesJson = new File(System.getProperty("user.dir") + File.separator + "APIHomework_1/names.json");
